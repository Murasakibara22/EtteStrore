...
<section class="w3l-grids-hny-2">
	...
	<div class="grids-hny-2-mian py-5">
		<div class="container py-lg-5">
			...
			<h3 class="hny-title mb-0 text-center">Acheter avec <span>EtteStore</span></h3>
			...
			<div class="welcome-grids row mt-5">
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="../images/Categorie/{{ $categories->photo}}" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">+
								</div>
							</a>
						</div>
						<h4><a href="#URL">{{ $categories->libelle}}</a></h4>
			 ...
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-left col-lg-6">
								<img src="MyAssets/assets/images/1.jpg" class="img-fluid" alt="">
						</div>
					</div>
				 </div>
			 </div>
...
<section class="w3l-ecommerce-main">
	...
	<div class="ecom-contenthny py-5">
		<div class="container py-lg-5">
			<h3 class="hny-title mb-0 text-center">Acheter avec <span>nous</span></h3>
			...
			<div class="ecom-products-grids row mt-lg-5 mt-3">
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2 transmitv">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-1.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-11.jpg">
							</a>
							<ul class="social">
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-2.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-22.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-3.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-33.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-4.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-44.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-5.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-55.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-6.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-66.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-7.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-77.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
				...
				<div class="col-lg-3 col-6 product-incfhny mt-4">
					<div class="product-grid2">
						<div class="product-image2">
							<a href="#">
								<img class="pic-1 img-fluid" src="MyAssets/assets/images/shop-8.jpg">
								<img class="pic-2 img-fluid" src="MyAssets/assets/images/shop-88.jpg">
							</a>
							<ul class="social">
									<li><a href="#" data-tip="Quick View"><span class="fa fa-eye"></span></a></li>
		...
		<div class="container py-lg-5">
			...
			<div class="post-hny-grids row mt-5">
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="#">
						<figure>
							<img class="img-fluid" src="MyAssets/assets/images/bg1.jpg" alt="blog-image">
						</figure>
					</a>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<a href="#">
						<figure>
							<img class="img-fluid" src="MyAssets/assets/images/bg2.jpg" alt="blog-image">
						</figure>
					</a>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<figure>
						<img class="img-fluid" src="MyAssets/assets/images/bg3.jpg" alt="blog-image">
					</figure>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
							<li><a href="#admin">By admin</a></li>
				...
				<div class="col-lg-3 col-md-6 grids5-info column-img" id="zoomIn">
					<figure>
						<img class="img-fluid" src="MyAssets/assets/images/bg4.jpg" alt="blog-image">
					</figure>
					<div class="blog-thumbhny-caption">
						<ul class="blog-info-list">
							<li><a href="#admin">By admin</a></li>
								...
								<div class="row">
									<div class="col-md-3">
										<div class="customer-info text-center">
											...
											<div class="feedback-review mt-4">
												<img src="MyAssets/assets/images/c1.jpg" class="img-fluid" alt="">
												<h5>Smith Roy</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="MyAssets/assets/images/c2.jpg" class="img-fluid" alt="">
														<h5>Lora Grill</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="MyAssets/assets/images/c3.jpg" class="img-fluid" alt="">
														<h5>Laura Sten</h5>
									...
									<div class="col-md-3">
											<div class="customer-info text-center">
													...
													<div class="feedback-review mt-4">
														<img src="MyAssets/assets/images/c4.jpg" class="img-fluid" alt="">
														<h5>John Lee</h5>
